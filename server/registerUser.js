...
async function main(userName) {
  try {
    ...
    const key = fs.readFileSync(path.join(credPath, '/msp/keystore/67daf957ebe5d408dafb9359e14ce4b77c49a5e65f7e6fd15ba3b2de31246da1_sk')).toString();
...
main('User1@org1.example.com'); //admin